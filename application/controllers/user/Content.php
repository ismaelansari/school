...
class Content extends Student_Controller {
    ...
    public function download($file) {
        ...
        $this->session->set_userdata('sub_menu', 'content/video');
        $student_id = $this->customlib->getStudentSessionUserID();
        $student = $this->student_model->get($student_id);
      
        $data['title_list'] = 'List of Video';
        $student_current_class = $this->customlib->getStudentCurrentClsSection();

        $list = $this->content_model->getListByCategoryforUser($student_current_class->class_id, $student_current_class->section_id, "Video");
        $data['list'] = $list;
        $this->load->view('layout/student/header');
        $this->load->view('user/content/video', $data);
        $this->load->view('layout/student/footer');
    }
