                                    ...
                                    foreach ($student_due_fee as $key => $fee) {
                                        foreach ($fee->fees as $fee_key => $fee_value) {
                                            ...
                                            if ($feetype_balance > 0 && strtotime($fee_value->due_date) < strtotime(date('Y-m-d'))) {
                                                ...
                                                ">
                                                    <?php echo paymentMode($fee->payment_mode??1) ?>

                                                </td>
                                                <td class="text text-left"><?php echo ($fee_value->bank_name_str) ?></td>
                                                <td class="text text-left"><?php echo ($fee->check_number) ?></td>
                                                <td class="text text-left"><?php echo ($fee->payment_app_name) ?></td>
                                                <td class="text text-left"></td>
                                            ...
                                            if (!empty($fee_value->amount_detail)) {
                                                ...
                                                foreach ($fee_deposits as $fee_deposits_key => $fee_deposits_value) {
                                                    ...
                                                    <tr class="white-td">
                                                        ...
                                                        <td class="text text-left"><?php echo paymentMode($fee_deposits_value->payment_mode); ?></td>
                                                        <td align="left"></td>
                                                        <td align="left"></td>
                                                        <td align="left"></td>
                                                        <td class="text text-left">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <label class="radio-inline">
                                    <input name="payment_mode" class="payment_mode" id="input-type-student" value="1" type="radio"  <?php echo set_radio('payment_mode', '1', true); ?> autocomplete="off">Cash
                                </label>
                                <label class="radio-inline">
                                    <input name="payment_mode" class="payment_mode" id="input-type-student" value="2" type="radio"  <?php echo set_radio('payment_mode', '2', false); ?> >Bank   
                                </label>
                                <label class="radio-inline">
                                ...
                                <span class="text-danger" id="payment_mode"></span>
                            </div>
                        </div>
...
<script type="text/javascript">
    $(document).on('click', '.save_button', function (e) {
        ...
        $.ajax({
            ...
            type: 'post',
            data: {date: date, type: feetype, amount: amount, amount_discount: amount_discount, amount_fine: amount_fine, description: description, student_fees_master_id: student_fees_master_id, fee_groups_feetype_id: fee_groups_feetype_id, payment_mode: payment_mode, guardian_phone: guardian_phone, guardian_email: guardian_email, student_fees_discount_id: student_fees_discount_id,parent_app_key:parent_app_key,bank_name:bank_name,check_number:check_number,app_name:app_name},
            dataType: 'json',
            success: function (response) {
