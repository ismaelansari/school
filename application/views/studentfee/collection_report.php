                ...
                <div class="box removeboxmius">
                    ...
                    <form role="form" action="<?php echo site_url('studentfee/collection_report') ?>" method="post" class="">
                        <div class="box-body row">
                            ...
                            <div class="col-sm-4 col-lg-4 col-md-4">
                                <div class="form-group">
                                    <label>Bank/Cash<small class="req"> *</small></label>
                    ...
                    <table class="table table-striped  table-hover " id="headerTable">
                       <thead class="header">
                                    <tr>
                                                    ...
                                                    <th><?php echo ('Check Number'); ?></th>
                                                    <th><?php echo ('Online App Name'); ?></th>
                            ...
                            foreach ($results as $key => $value) {
                                        ...
                                        $pay_mode[$collect['id']]=$collect['payment_mode'];
                                        $bank_name[$collect['id']]=$collect['bank_name_str'];
                                        $check_number[$collect['id']]=$collect['check_number'];
                                        $online_app[$collect['id']]=$collect['payment_app_name'];
                                                    ...
                                                    <tr>
                                                       ...
                                                       <table width="100%"><?php foreach($fees_type as $fees_type_val){
                                                        ...
                                                        <table width="100%"><?php foreach($pay_mode as $pay_mode_val){
                                                            ?>
                                                            <tr><td><?php echo paymentMode($pay_mode_val);?></td></tr>
                                                            <?php
                                                        } ?>
                                                        </table>
                                                        </td>
                                                        <td><table width="100%"><?php foreach($bank_name as $bn){
                                                            ?>
                                                            <tr><td><?php echo $bn??'-';?></td></tr>
                                                            <?php
                                                        } ?>  </table></td>
                                                        <td><table width="100%"><?php foreach($check_number as $cn){
                                                            ?>
                                                            <tr><td><?php echo $cn??'-';?></td></tr>
                                                            <?php
                                                        } ?>  </table></td>
                                                        <td><table width="100%"><?php foreach($online_app as $oa){
                                                            ?>
                                                            <tr><td><?php echo $oa??'-';?></td></tr>
                                                            <?php
                                                        } ?>  </table></td>
