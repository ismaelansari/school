                        ...
                        <form action="<?php echo site_url("admin/expense/edit/" . $id) ?>"  id="employeeform" name="employeeform" method="post" accept-charset="utf-8"  enctype="multipart/form-data">
                            <div class="box-body">
                                                ...
                                                <div id="input-type" class="row">
                                                    <div class="col-sm-4">
                                                        <label class="radio-inline">
                                                            ...
                                                            <input name="payment_mode" class="payment_mode" id="input-type-student" value="1" type="radio"  <?php echo set_radio('payment_mode', '1', (set_value('1', $expense['payment_mode'] == "1") ? TRUE : FALSE)); ?> autocomplete="off">Cash                                                        </label>
                                                    </div>
                                                    <div class="col-sm-4">
                                                        <label class="radio-inline">
                                                            <input name="payment_mode" class="payment_mode" id="input-type-student" value="2" type="radio"  <?php echo set_radio('payment_mode', '2', (set_value('2', $expense['payment_mode'] == "2") ? TRUE : FALSE)); ?> >Bank                                                        </label>
                                                    </div>
                                                    <div class="col-sm-4">
                                                        <label class="radio-inline">
                                                            <input name="payment_mode" class="payment_mode" id="input-type-tutor" value="3" type="radio"  <?php echo set_radio('payment_mode', '3', (set_value('3', $expense['payment_mode'] == "3") ? TRUE : FALSE)); ?> >
                                ...
                                <div class="form-group check_number">
                                    ...
                                    <input id="check_number" name="check_number" placeholder="" type="text" class="form-control"  value="<?php echo set_value('check_number',$expense['check_number']); ?>" />
                                ...
                                <div class="form-group app_name">
                                    ...
                                    <input id="app_name" name="app_name" placeholder="" type="text" class="form-control"  value="<?php echo set_value('app_name',$expense['payment_app_name']); ?>" />
