                                ...
                                <td valign="top">
                                    <table cellpadding="0" cellspacing="0" width="100%">
                                        ...
                                        if ($template->heading != "") {
                                            ?>
                                            <tr>
                                                 <td valign="top"><img src="<?php echo base_url('uploads/print_headerfooter/student_receipt/Spnheader.png'); ?>" class="tcmybg" width="80%"  style="height: 150px; width:100% "/></td>
                            ...
                            <td valign="top">
                                <table cellpadding="0" cellspacing="0" width="100%" class="">
                                    ...
                                    if ($template->is_father_name) {
                                        ?>
                                        <tr>
                                            <td valign="top" style="text-transform: uppercase; padding-bottom: 15px;">Father's Name<span style="padding-left: 30px; font-weight: bold;"><?php echo $student_value['father_name']; ?></span></td>
                                        </tr>
                                        <?php
                                    }
    ...
    <?php
                                    ...
                                    ?>
                                          <tr>
                                            ...
                                            <td valign="top" style="text-transform: uppercase; padding-bottom: 15px;">SSSMID<span style="padding-left: 30px; font-weight: bold;"><?php echo $student_value['samagra_id']; ?></span></td>
                                            <td valign="top" style="text-transform: uppercase; padding-bottom: 15px;">DOB<span style="padding-left: 30px; font-weight: bold;"><?php echo date("d-m-Y",strtotime($student_value['dob'])) ?></span></td>
                                        </tr>             
