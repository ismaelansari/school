                                 ...
                                 <?php
                                                ...
                                                foreach ($incomeList as $key => $values) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <?php echo paymentMode($values['payment_mode']); ?>
                                                        </td>
                                                        <td>
                                                            <?php echo $values['bank_name_str']; ?>
                                                        </td>
                                                        <td>
                                                            <?php echo $values['check_number']; ?>
                                                        </td>
                                                        <td>
                                                            <?php echo $values['payment_app_name']; ?>
                                                        </td>
