            ...
            <?php if ($this->rbac->hasPrivilege('session_setting', 'can_add') || $this->rbac->hasPrivilege('session_setting', 'can_edit')) { ?>
                <div class="col-md-4">
                    <div class="box box-primary">
                        ...
                        <form action="<?php echo site_url("sessions/editbank/" . $id) ?>"  id="employeeform" name="employeeform" method="post" accept-charset="utf-8">
                            <div class="box-body">                          
                                ...
                                <div class="form-group">
                                    ...
                                    <input autofocus="" id="name" name="name" placeholder="" type="text" class="form-control"  value="<?php echo set_value('name', $session['name']); ?>" />
                                    <span class="text-danger"><?php echo form_error('name'); ?></span>
                                </div>

                                <label class="radio-inline">

                                <input name="is_active" class="is_active" id="input-type-student" value="1" type="radio"  <?php echo set_radio('is_active', '1', (set_value('1', $session['is_active'] == "1") ? TRUE : FALSE)); ?> autocomplete="off">Active</label>

                                <label class="radio-inline">

                                <input name="is_active" class="is_active" id="input-type-student" value="0" type="radio"  <?php echo set_radio('is_active', '0', (set_value('0', $session['is_active'] == "0") ? TRUE : FALSE)); ?> autocomplete="off">DeActive</label>
